 ...
 *   Commit:  a0e4c241d27ec9e70310910ba5c747aca946c78d
 *   Date:    2026-06-09
 *   License: GNU AGPL-3.0-only (see ./LICENSE, ./ATTRIBUTION.md)
 *   Author:  @koala73
 *
 * Local modifications (if any) are visible in this repository's git history.
 */
...
const COUNTRY_GEOJSON_URL = '/vendor/worldmonitor/countries.geojson';

/** Optional higher-resolution boundary overrides sourced from Natural Earth. */
const COUNTRY_OVERRIDES_URL = '/vendor/worldmonitor/country-boundary-overrides.geojson';
